...
filename = os.path.join(directory, 'brightness_3_2' + datetime.datetime.now().strftime("%Y%m%d_%H%M%S") + '.csv') #change 'orignal' to method of augmentation tried.
...
shutil.copyfile(filename,dir_to_save+'brightness32')