...
Original file is located at
    https://colab.research.google.com/drive/1dDC6rux0cRocVZYSwQczRnpKTuyfw9jV
"""
...
filename = os.path.join(directory, 'original' + datetime.datetime.now().strftime("%Y%m%d_%H%M%S") + '.csv') #change 'orignal' to method of augmentation tried.
